...
builder.defineSubtitlesHandler(async function(args) {
    ...
    function calculateScore(subTitle, rating) {
        ...
        if (videoFilename) {
            // 1. MATCH SUPREM (+100 puncte): Baza de date cu 558 grupuri The Scene/P2P
            ...
            for (let g of groups) {
                // Filtru strict: cerem ca grupul să fie precedat de caractere non-alfanumerice (cum ar fi cratima, punctul) 
                // sau să fie la sfârșitul cuvântului, pentru a evita potrivirile greșite cu cuvinte normale (ex: 'bs' in 'subs')
    ...
    // Ordonăm lista descrescător. Locul 1 intră automat!
